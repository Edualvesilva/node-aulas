import http from 'http'; // importando o módulo nativo http, mesmo sendo um módulo nativo, ainda assim precisamos do package.js
...
const monitorRequisicao = (req, res) => {
    ...
    // Avaliando cada requisição (a parte do link)
    switch (req.url) {
        case '/':
